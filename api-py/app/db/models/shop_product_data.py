"""商品数据(表 shop_product_data,snake_case)。"""
...
class ShopProductData(Base):
    __tablename__ = "shop_product_data"
    ...
    active_spu_count: Mapped[Optional[int]] = mapped_column(nullable=True)
    spu_active_rate: Mapped[Optional[float]] = mapped_column(nullable=True)
    ...
    item_unit_price: Mapped[Optional[float]] = mapped_column(nullable=True)
    cart_spu_count: Mapped[Optional[int]] = mapped_column(nullable=True)
    spu_cart_rate: Mapped[Optional[float]] = mapped_column(nullable=True)
    ...
    visit_spu_count: Mapped[Optional[int]] = mapped_column(nullable=True)
    ...
    listed_spu_count: Mapped[Optional[int]] = mapped_column(nullable=True)
